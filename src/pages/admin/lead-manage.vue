  ...
  <view class="page">
    ...
    <scroll-view class="list-scroll" scroll-y :refresher-enabled="true" :refresher-triggered="refreshing" @refresherrefresh="onRefresh">
      <view class="lead-list" :class="{ 'animate-in': animated }">
        <view class="lead-item" v-for="(item, idx) in filteredList" :key="item._id" @tap="goDemand(item.demand_id)"
...
.lead-actions { display: flex; gap: 12rpx; padding-top: 12rpx; border-top: 1rpx solid #F5F6FA; }
