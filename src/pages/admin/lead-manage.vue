...
.lead-actions { display: flex; gap: 12rpx; padding-top: 12rpx; border-top: 1rpx solid rgba(255,255,255,0.06); }
...
.action-btn.warn { background: rgba(255,255,255,0.08); color: rgba(255,255,255,0.45); }
