<template>
  <view class="publish-page">
    ...
    <view class="form-wrap">
      ...
      <view class="form-card">
        <text class="form-label">{{ t('demand.quote') }}</text>
      ...
      <view v-if="form.quote_type === 'self'" class="form-card">
        <text class="form-label">{{ t('demandPublish.budgetRange') }}</text>
      ...
      <view class="form-card">
        <text class="form-label">{{ t('demandPublish.detailLabel') }}</text>
    ...
    <view class="bottom-bar">
      ...
      <view class="submit-btn" @tap="submitForm"><text>{{ isEdit ? t('demandPublish.saveChanges') : t('demand.publish') }}</text></view>
    </view>
...
function doSubmit() {
  ...
  try {
    if (isEdit.value) {
      ...
      uni.showToast({ title: t('demandPublish.publishSuccess'), icon: 'success' })
