...
.cat-color-0 { background: rgba(255,107,53,0.15); }
.cat-color-1 { background: rgba(99,102,241,0.15); }
.cat-color-2 { background: rgba(16,185,129,0.15); }
.cat-color-3 { background: rgba(245,158,11,0.15); }
.cat-color-4 { background: rgba(59,130,246,0.15); }
.cat-color-5 { background: rgba(236,72,153,0.15); }
.cat-color-6 { background: rgba(139,92,246,0.15); }
.cat-color-7 { background: rgba(6,182,212,0.15); }
...
.zone-icon { font-size: 28rpx; display: block; margin-bottom: 8rpx; }
