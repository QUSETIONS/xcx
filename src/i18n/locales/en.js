...
export default {
  ...
  deals: {
    ...
    reviewed: 'Reviewed ✓',
    empty: 'No deals yet',
    reviewTitle: 'Rate this collaboration',
    reviewPlaceholder: 'Share your experience...',
    submitReview: 'Submit',
    confirmTitle: 'Confirm Completion',
    confirmContent: 'Confirm this deal is done? You can review after.',
    confirmed: 'Confirmed',
    ...
    tags: ['Professional', 'Prompt', 'Reliable', 'Great Value', 'Smooth Comms', 'Creative']
  },
  message: {
  ...
  dashboard: {
    ...
    viewsCount: 'Views',
    leadsCount: 'Leads',
    categoryTitle: 'Demand Category Distribution',
    countUnit: '',
  ...
  admin: {
    ...
    online: 'Online',
    delete: 'Delete',
    emptyDemand: 'No demands',
    emptyLead: 'No leads',
    emptyOrder: 'No orders',
    emptyProduct: 'No products',
    confirmOffline: 'Confirm Offline',
    offlineContent: 'Take "{title}" offline?',
    offlined: 'Taken offline',
    confirmOnline: 'Confirm Online',
    onlineContent: 'Put "{title}" online?',
    onlined: 'Put online',
    confirmDelete: 'Confirm Delete',
    deleteContent: 'Delete "{title}"?',
    deleted: 'Deleted',
    contacted: 'Contacted',
    deal: 'Deal',
    invalid: 'Invalid',
    ...
    addContent: 'Add product info in the admin system.',
    gotIt: 'Got it',
    setFeatured: 'Set Featured',
    unsetFeatured: 'Unset Featured',
    editPrice: 'Edit Price',
    toggleSale: 'Toggle Listing',
    featuredSet: 'Set as featured',
    featuredUnset: 'Removed from featured',
    editPricePlaceholder: 'Enter new price (CNY)',
    priceUpdated: 'Price updated',
    onSale: 'Listed',
    offSale: 'Delisted',
    screenTitle: 'QiYeKu · Ops Data Center',
    live: 'LIVE',
